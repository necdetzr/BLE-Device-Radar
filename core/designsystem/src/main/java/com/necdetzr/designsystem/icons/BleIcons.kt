...
object BleIcons {
    ...
    val BluetoothScanning = Icons.AutoMirrored.Rounded.BluetoothSearching
    ...
    val Start = Icons.Default.PlayCircleFilled
    val Stop = Icons.Default.StopCircle
    val Dark = Icons.Default.DarkMode
    val Light = Icons.Default.LightMode
    val System = Icons.Default.SettingsSuggest
    val Fingerprint = Icons.Default.Fingerprint
    val Copy = Icons.Default.ContentCopy
    val Done = Icons.Default.Done
    val DownArrow = Icons.Default.ArrowDropDown
    val UpArrow = Icons.Default.ArrowDropUp
    val Distance = Icons.Default.LocationSearching
    val Time = Icons.Default.AccessTime
    val Energy = Icons.Default.PowerInput
    val Connect = Icons.Default.Link
    val Packet = Icons.Default.Inbox
